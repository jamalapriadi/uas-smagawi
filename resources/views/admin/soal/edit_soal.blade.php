...
@section('content')
	...
	{{Form::open(array('url'=>'admin/update-soal','method'=>'post'))}}
	<div class="row">
		<div class="col-lg-8">
			<div class="form-group">
				<label for="">Pertanyaan</label>
				<input type="hidden" name="kode" value="{{$detail->id}}">
				<textarea name="pertanyaan" class="form-control" id="pertanyaan" cols="30" rows="10">{{$detail->pertanyaan}}</textarea>
			</div>

			<div class="form-group">
				<label for="">Jawaban A</label>
				<input type="text" name="jawabana" value="{{$detail->jawaban_a}}" class="form-control">
			</div>

			<div class="form-group">
				<label for="">Jawaban B</label>
				<input type="text" name="jawabanb" value="{{$detail->jawaban_b}}" class="form-control">
			</div>

			<div class="form-group">
				<label for="">Jawaban C</label>
				<input type="text" name="jawabanc" value="{{$detail->jawaban_c}}" class="form-control">
			</div>

			<div class="form-group">
				<label for="">Jawaban D</label>
				<input type="text" name="jawaband" value="{{$detail->jawaban_d}}" class="form-control">
			</div>

			<div class="form-group">
				<label for="">Jawaban E</label>
				<input type="text" name="jawabane" value="{{$detail->jawaban_e}}" class="form-control">
			</div>
			...
			<div class="form-group well">
				...
				<a href="{{URL::to('admin/soal/'.$detail->id_soal)}}" class="btn btn-default">
					Kembali
				</a>
			</div>
		</div>
